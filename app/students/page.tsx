    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="bg-[#88957d] text-white">
          <CardContent className="p-6">
            ...
            <p className="text-sm opacity-90 mt-2">Mais alunos que semana passada</p>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="bg-white/90 backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="text-[#7f6e62]">Atividades do dia</CardTitle>
          </CardHeader>
          <CardContent>
            <div
            ...
            >
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-2">
                    <Button size="sm" className="bg-[#d09c91] hover:bg-[#7f6e62] text-white">
                      Visualizar
                    </Button>
                    <Button size="sm" className="bg-[#d09c91] hover:bg-[#7f6e62] text-white">
                      Editar
